...
!=======================================================================================================================    
    ...
    if (use_hice.eq.1) call fabm_link_horizontal_data(model, standard_variables%ice_thickness, hice)    !m
...
!=======================================================================================================================    
    ...
    do i_day=0,(last_day-1)                               !BIG Cycle ("i_day"=0,...,last_day-1)
        ...
        if (use_hice.eq.1) call fabm_link_horizontal_data(model, standard_variables%ice_thickness, hice(julianday:julianday))
